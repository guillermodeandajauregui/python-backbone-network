...
G = graphfromsif("path/to/network.sif")
print("loaded graph")
print("calculating disparity")
GDF = disparity_filter(G)
print("disparity calculated")
print("filtering")
GDF_04 = disparity_filter_alpha_cut(GDF,weight='weight',alpha_t=0.4, cut_mode='or')
print("filtered")
print("writeout")
nx.write_edgelist(GDF_04, path="path/to/output.sif", data=True)
print("YEAH!")
